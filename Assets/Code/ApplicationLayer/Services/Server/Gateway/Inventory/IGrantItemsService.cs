...
{
    public interface IGrantItemsService                                                         //Es un servicio que se encarga de dar los items a los usuarios, y si es la primera vez los items iniciales al usuario.
    {
